                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        ...
                                        <form style="display: inline" action="{{ route('manajemen-akun.destroy', $user) }}"
                                            method="post">
                                            @csrf
                                            @method('delete')
                                            <button type="button"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" action="{{ route('manajemen-akun.store') }}" method="post" id="tambahUser">
                        @csrf
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                ...
                                <input class="form-control mb-1 @error('email') is-invalid @enderror" minlength="3"
                                    maxlength="35" type="email" id="email" placeholder="Masukan Email Anda"
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                ...
                                <input class="form-control mb-1 @error('no_hp') is-invalid @enderror" type="text"
                                    id="no_hp" placeholder="Masukan Nomor Hp Anda" name="no_hp"
                                    value="{{ old('no_hp') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                ...
                                <input class="form-control mb-1 @error('alamat') is-invalid @enderror" type="text"
                                    id="alamat" placeholder="Masukan Alamat Anda" name="alamat"
                                    value="{{ old('alamat') }}">
                            </div>
                        </div>
    ...
    <div class="modal fade" id="editUserModal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" action="{{ route('manajemen-akun.update', '') }}" id="editUser" method="POST"
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            ...
                            <input class="form-control mb-1 @error('edit_no_hp') is-invalid @enderror" type="number" id="edit_no_hp" placeholder="Masukkan No Hp"
                                name="edit_no_hp" value="{{ old('edit_no_hp') }}" required>
                            @error('edit_no_hp')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <label for="alamat">Alamat</label>
                            <input class="form-control mb-1 @error('edit_alamat') is-invalid @enderror" type="text" id="edit_alamat" placeholder="Masukkan Alamat"
                                name="edit_alamat" value="{{ old('edit_alamat') }}" required>
                            @error('edit_alamat')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                $("#tambahUser").validate({
                    rules: {
                        ...
                        email: {
                            ...
                            maxlength: 30,
                            remote: {
                                    url: "{{ route('manajemen-akun.checkEmail') }}",
                                    type: "post",
                            }
                        },
                        no_hp : {
